...
INDIR=/datasets/marta/Wang2020/RNASeq
FQDIR=/users/genomics/marta/Wang2020/${specie}/RNASeq/fastq
mkdir -p $FQDIR

QCDIR=/users/genomics/marta/Wang2020/${specie}/RNASeq/QC
mkdir -p $QCDIR
...
BAMDIR=/users/genomics/marta/Wang2020/${specie}/RNASeq/STAR
