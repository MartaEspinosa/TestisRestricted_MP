...
gene_transcript = read.table("/genomics/users/marta/genomes/1transcript_1gene.txtsep= header=T)
...
toc_TPMs_long$patient = paste0("Patienttoc_TPMs_long$patient)
## get tissue data
...
table(ribORF_humanTestis_in2_fastas$gene_type)
...
testisRestrictedGTEx_Translated = merge(subset_testis_GTEx_w_novels %>% select(gene_id, gene_type, gene_name), ribORF_humanTestis_in2_fastas, by=c("gene_id"gene_name"gene_type")) 
...
ggpie(to_plot, "n label="n fill="gene_type lab.pos = "out   lab.font = c(5, "plain "black"),
      palette=c("protein_coding"="#CC79A7
                 ...
                 "processed_pseudogene" = "#0090B2
                 "novel" = "#E69F00")) +
  ggtitle("ORFs from testis-Restricted GTEx genes translated in testis (2 samples at least)")
...
testisRestrictedGTEx_Translated = testisRestrictedGTEx_Translated %>% mutate("TranslatedLiver" = case_when(orfID %in% ribORF_humanLiver_simplified$orfID ~ "yesTRUE ~ "no")) %>% mutate("TranslatedBrain" = case_when(orfID %in% ribORF_humanBrain_simplified$orfID ~ "yesTRUE ~ "no"))
...
ggpie(to_plot_translatedOnlyTestis, "n label="n fill="gene_type lab.pos = "out palette=c("protein_coding"="#CC79A7
                         ...
                         "processed_pseudogene" = "#0090B2
                                          "novel" = "#E69F00")) +
  ggtitle("ORFs from testis-expressed genes translated ONLY in testis (2 samples at least)")
