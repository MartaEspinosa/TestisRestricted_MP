...
## get patient number
toc_TPMs_long$patient = str_sub(toc_TPMs_long$sample, start= -1)
...
testisRestrictedGTEx_Translated = merge(testisExpressed %>% select(gene_id, gene_type, gene_name, testisRestricted_GTEx), ribORF_humanTestis_in2_fastas, by=c("gene_id","gene_name","gene_type"))
nrow(testisRestrictedGTEx_Translated)
table(testisRestrictedGTEx_Translated$testisRestricted, testisRestrictedGTEx_Translated$gene_type)
testisRestrictedGTEx_Translated = testisRestrictedGTEx_Translated %>% select(-ORFseq)
testisRestrictedGTEx_Translated = testisRestrictedGTEx_Translated %>% subset(testisRestricted_GTEx == "yes")
