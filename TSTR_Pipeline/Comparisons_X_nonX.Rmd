...
annot = UpSetRannot = read.csv("/users/genomics/marta/TestisProject_SaraRazquin/with_TranscriptomeReconstruction/v47/human/newReference_Resconstructed/transID_geneID_isoforms_selected.1to1.csv")
...
ComplexUpset::upset(
  ...
  annotations = list("Coding Type" = (
    ggplot(mapping = aes(fill=coding_noncoding_chr)) +
      ...
      scale_fill_manual(values=c("CT-X" = "#833437", "CT-nonX" = "#ead890", "Noncoding-nonX" = "#646c31", "Noncoding-X" = "grey")) +
        ylab("Coding Type")
)),     width_ratio=0.1
)
dev.off()
