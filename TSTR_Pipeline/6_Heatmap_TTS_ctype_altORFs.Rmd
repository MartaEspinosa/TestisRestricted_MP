...
mycolors = list("gene_typ"=c("protein_coding"="#ead890",
                       "lncRNA" = "#cd4f38",
...
# for (ctype_var in c("BLCA")) {
  ...
  if (length(gene_names_ctype) > 4) {
      ...
      corrplot(lncRNA_cormat, type = "lower", order = "hclust", method="circle",
               tl.col = "black", col = COL2('BrBG', 10), tl.cex=0.6, title=paste0("Correlation non-CTA TTS genes",  ctype_var),  mar=c(0,0,1,0));
        recordPlot() 
      }
