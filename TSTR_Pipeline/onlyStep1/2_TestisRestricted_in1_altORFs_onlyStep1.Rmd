...
ggsave(file.path(plots_wd,"length_density.jpeg"), height=4.45, width=5.30)
...
ggplot(toc_TPMs_long, aes(x=patient, y=log2TPM, fill=tissue))+
  ...
  facet_wrap(~ tissue)
ggsave(file.path(plots_wd,"TPM_boxplot_tissue.jpeg"), height=4.45, width=4.30)
...
ggsave(file.path(plots_wd,"TPM_boxplot_biotype.jpeg"), height=4.45, width=4.30)
...
ggsave(file.path(plots_wd,"expressed_specific_piecharts.jpeg"))
``` 
...
ggsave(file.path(plots_wd,"testisExpressed_testisRestricted.jpeg"), height=5.69, width=4.72)
...
ggsave(file.path(plots_wd,"testisExpressed_testisRestricted_GTEx.jpeg"), height=5.69, width=4.72)
```
...
ggplot(merged_spGTEx, aes(x=tissue, fill=condition, y=values)) +
  ...
  theme_minimal()
ggsave(file.path(plots_wd,"condition_tissue_barplot.jpeg"))
...
ggsave(file.path(plots_wd,"Restricted_with_GTEx_piecharts.jpeg"))
...
ggsave(file.path(plots_wd,"testisExpressed_translated.jpeg"), height=4.69, width=5.4)
...
ggpie(to_plot, "n", label="n", fill="geneORFtype", lab.pos = "out", lab.font = c(3, "plain", "black"),
  ...
  ggtitle("ORFs from testis-Expressed genes only translated in testis (1 sample at least)")
ggsave(file.path(plots_wd,"testisExpressed_translated_altORFs.jpeg"), height=4.69, width=5.4)
```
...
ggsave(file.path(plots_wd,"testisRestrictedGTEx_translated.jpeg"), height=4.69, width=5.4)
...
ggpie(to_plot, "n", label="n", fill="geneORFtype", lab.pos = "out",   lab.font = c(5, "plain", "black"),
  ...
  ggtitle("ORFs from testis-Restricted GTEx genes translated in testis (1 sample at least)")
ggsave(file.path(plots_wd,"testisRestrictedGTEx_translated_altORFs.jpeg"), height=4.69, width=5.4)
```
...
ggsave(file.path(plots_wd,"testisRestricted_translated_tissues.jpeg"), height=4.69, width=5.4)
...
ggsave(file.path(plots_wd,"testisRestricted_translated_tissues_lncRNA.jpeg"), height=4.69, width=5.4)
...
ggsave(file.path(plots_wd,"testisRestricted_translated_tissues_proteincoding.jpeg"), height=4.69, width=5.4)
...
print("genes")
table(testisRestrictedGTEx_Translated_onlyTestis %>% select(gene_id, geneORFtype) %>% unique() %>% pull(geneORFtype))
...
ggpie(to_plot_translatedOnlyTestis, "n", label="n", fill="gene_type", lab.pos = "out", palette=c("protein_coding"="#ead890",
                       "lncRNA" = "#cd4f38",
                       "processed_pseudogene" = "#e48c2a",
                                             "novel" = "#637c68")) +
  ggtitle("ORFs from testis-expressed genes translated ONLY in testis (1 sample at least)")
ggsave(file.path(plots_wd,"testisRestricted_ORFs_onlyTestis.jpeg"), height=4.69, width=5.4)
...
ggpie(to_plot_translatedOnlyTestis, "n", label="n", fill="geneORFtype", lab.pos = "out", 
  ...
  ggtitle("ORFs from testis-expressed genes translated ONLY in testis (1 sample at least)")
ggsave(file.path(plots_wd,"testisREstricted_altORFs_onlyTestis.jpeg"), height=4.69, width=5.4)  
```
...
ggarrange(top,bottom)
ggsave(file.path(plots_wd,"translated_expressed_specific_piecharts.jpeg"))
...
ggplot(merged_spGTEx_transl, aes(x=tissue, fill=condition, y=values)) +
  ...
  scale_fill_manual(values=c("Expressed" = "#d9f0d3","Restricted" = "#5aae61", "Restricted with GTEx" = "#00441b")) +
  theme_minimal()
ggsave(file.path(plots_wd,"condition_tissue_barplot_translated.jpeg"))
...
ggsave(file.path(plots_wd,"Translated_Restricted_with_GTEx_piecharts.jpeg"))
...
print(length(unique(CTDB_translated_only_testis$gene_name)))
