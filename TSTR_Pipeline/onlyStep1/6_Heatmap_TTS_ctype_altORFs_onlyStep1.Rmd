...
# for (ctype_var in c("BLCA")) {
  ...
  if (dim(df_5percent)[1] > 0) {
    ...
    if (nrow(nozeros_matrix_log) > 4) {
      ...
      pdf(paste0(plots_wd,"/corrplot_allgenes_TOv3x_",ctype_var,".pdf"))
      replayPlot(p)
      dev.off()
  ...
  if (length(gene_names_ctype) > 4) {
    ...
    pdf(paste0(plots_wd,"/corrplot_nonCTA_TOv3x_",ctype_var,".pdf"))
    replayPlot(p)
    dev.off()
  ...
  if (length(gene_names_ctype) > 4) {
    ...
    pdf(paste0(plots_wd,"/corrplot_CTA_TOv3x_",ctype_var,".pdf"))
    replayPlot(p)
    dev.off()
  ...
  if (length(gene_names_ctype) > 4) {
    ...
    pdf(paste0(plots_wd,"/corrplot_CTAX_TOv3x_",ctype_var,".pdf"))
    replayPlot(p)
    dev.off()
  ...
  if (length(gene_names_ctype) > 4) {
    ...
    pdf(paste0(plots_wd,"/corrplot_CTAnonX_TOv3x_",ctype_var,".pdf"))
    replayPlot(p)
    dev.off()
  }
  ...
  if (length(gene_names_ctype) > 4) {
    ...
    pdf(paste0(plots_wd,"/corrplot_nonCTAX_TOv3x_",ctype_var,".pdf"))
    replayPlot(p)
    dev.off()
  ...
  if (length(gene_names_ctype) > 4) {
    ...
    pdf(paste0(plots_wd,"/corrplot_nonCTAnonX_TOv3x_",ctype_var,".pdf"))
    replayPlot(p)
    dev.off()
  }
  ...
  if (length(gene_names_ctype) > 4) {
    ...
    pdf(paste0(plots_wd,"/corrplot_lncRNA_TOv3x_",ctype_var,".pdf"))
    replayPlot(p)
    dev.off()
  }
  }
