...
```{r, echo=FALSE}
# Hago el merge
gtex2<-merge(raw_gtex, transltable, by="Geneid", all.y=T) # en esta tabla los NA son los que perdemos !!!!!!!! all.y=T !!!
...
gtex_table = gtex2_noNA_symbols
```

```{r, echo=FALSE}
dim(gtex_table)
sub_gtex_table<-gtex_table[,c(2:32)]
```
