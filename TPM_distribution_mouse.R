...
ggplot(shared_n, aes(x=num_patients, y=num_genes, color=gene_type)) +
  ...
  theme_classic()
ggsave("/users/genomics/marta/TestisProject_SaraRazquin/with_TranscriptomeReconstruction/mouse/plots/PNG/shared_genes.300.png", width=6.64, height=8.78)
ggsave("/users/genomics/marta/TestisProject_SaraRazquin/with_TranscriptomeReconstruction/mouse/plots/PDF/shared_genes.300.pdf", width=6.64, height=8.78)
