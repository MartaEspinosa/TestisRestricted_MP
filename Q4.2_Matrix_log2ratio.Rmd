...
TSA_TestisGTEx_Translated = read.csv(file.path(save_wd,"TOv3x_5percent_TestisRestrictedGTEx_Translated_Ctypes_log2ratio3xMEAN.csv"))
...
#                                                                                   TRUE ~ 0))
write.csv(step2, file.path(save_wd,"TOv3xlog2ratio3xMEAN_forcedTPM_patients.csv"), row.names=F)
...
write.csv(step3_2, file.path(save_wd,"TOv3xlog2ratio3xMEAN_forcedTPM_patients_normals.csv"), row.names=F)

data_completed_TSA_forced = read.csv(file.path(save_wd,"TOv3xlog2ratio3xMEAN_forcedTPM_patients.csv"))
