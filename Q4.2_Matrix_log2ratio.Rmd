...
TSA_TestisGTEx_Translated = read.csv(file.path(save_wd,"TOv3x_5percent_TestisRestrictedGTEx_Translated_Ctypes_log2ratio3x.csv"))
...
# 
# ## save the data
# write.csv(data_completed_TSA, file.path(save_wd,"TTS_TPM_patients_log2ratio.csv"), row.names=F)
...
#                                                                                   TRUE ~ 0))
write.csv(step2, file.path(save_wd,"TOv3xlog2ratio3x_forcedTPM_patients.csv"), row.names=F)
...
write.csv(step3_2, file.path(save_wd,"TOv3xlog2ratio3x_forcedTPM_patients_normals.csv"), row.names=F)

data_completed_TSA_forced = read.csv(file.path(save_wd,"TOv3xlog2ratio3x_forcedTPM_patients.csv"))
