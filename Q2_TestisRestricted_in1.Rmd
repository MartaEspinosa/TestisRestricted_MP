...
plots_wd = "/projects_eg/projects/marta/TestisRestricted_Microproteins_TSA/with_TranscriptomeReconstruction/Q2_TestisRestricted/human/plots"
save_wd = "/projects_eg/projects/marta/TestisRestricted_Microproteins_TSA/with_TranscriptomeReconstruction/Q2_TestisRestricted/human"
```
...
a2 = ggpie(brainsp_genetype_plot, x="Freq", fill = "Var1", palette=c("protein_coding"="#849DB1",
                 "lncRNA" = "#B66353",
                 "processed_pseudogene" = "#FBB04E",
                 "novel" = "#B09C85")) + 
...
b2 =ggpie(liversp_genetype_plot, x="Freq", fill = "Var1", palette=c("protein_coding"="#849DB1",
                 "lncRNA" = "#B66353",
                 "processed_pseudogene" = "#FBB04E",
                 "novel" = "#B09C85")) + 
...
c2 = ggpie(testissp_genetype_plot, x="Freq", fill = "Var1", palette=c("protein_coding"="#849DB1",
                 "lncRNA" = "#B66353",
                 "processed_pseudogene" = "#FBB04E",
                 "novel" = "#B09C85")) + 
...
ggplot(merged_spGTEx, aes(x=tissue, fill=condition, y=values)) +
  ...
  scale_fill_manual(values=c("Expressed" = "#5aae61","Restricted" = "#d9f0d3", "Restricted with GTEx" = "#00441b")) +
  theme_minimal()
...
a3 = ggpie(brainspgtex_genetype_plot, x="Freq", fill = "Var1", palette=c("protein_coding"="#849DB1",
                 "lncRNA" = "#B66353",
                 "processed_pseudogene" = "#FBB04E",
                 "novel" = "#B09C85")) + 
...
b3 = ggpie(liverspgtex_genetype_plot, x="Freq", fill = "Var1", palette=c("protein_coding"="#849DB1",
                 "lncRNA" = "#B66353",
                 "processed_pseudogene" = "#FBB04E",
                 "novel" = "#B09C85")) + 
...
c3 = ggpie(testisspgtex_genetype_plot, x="Freq", fill = "Var1", palette=c("protein_coding"="#849DB1",
                 "lncRNA" = "#B66353",
                 "processed_pseudogene" = "#FBB04E",
                 "novel" = "#B09C85")) + 
...
## translation
ribORF_humanTestis_in1_fastas = read.csv("/projects_eg/projects/marta/TestisRestricted_Microproteins_TSA/with_TranscriptomeReconstruction/Q1_TestisORFs/human/ribORF_humanTestis_in1.csv")
table(ribORF_humanTestis_in1_fastas$gene_type)

nrow(testisExpressed)
table(testisExpressed$gene_type)
## how many of the testis expressed are translated?
testisExpressed_Restricted_Translated = merge(testisExpressed %>% select(gene_id, gene_type, gene_name, testisRestricted), ribORF_humanTestis_in1_fastas, by=c("gene_id","gene_name","gene_type"))
...
testisRestrictedGTEx_Translated = merge(subset_testis_GTEx_w_novels %>% select(gene_id, gene_type, gene_name), ribORF_humanTestis_in1_fastas, by=c("gene_id","gene_name","gene_type")) 
...
## ---------- LIVER -----------##
ribORF_humanLiver_Annotated_biotypes = read.csv("/projects_eg/projects/marta/TestisRestricted_Microproteins_TSA/with_TranscriptomeReconstruction/Q1_TestisORFs/human/ribORF_humanLiver_translated.csv")
...
## ---------- BRAIN -----------##
ribORF_humanBrain_Annotated_biotypes = read.csv( "/projects_eg/projects/marta/TestisRestricted_Microproteins_TSA/with_TranscriptomeReconstruction/Q1_TestisORFs/human/ribORF_humanBrain_translated.csv")
...
ggpie(to_plot_translatedOnlyTestis, "n", label="n", fill="gene_type", lab.pos = "out", palette=c("protein_coding"="#849DB1",
                         "lncRNA" = "#B66353",
                         "processed_pseudogene" = "#FBB04E",
                                          "novel" = "#B09C85")) +
...
a2 = ggpie(transl_brainsp_genetype_plot, x="Freq", fill = "Var1", palette=c("protein_coding"="#849DB1",
                 "lncRNA" = "#B66353",
                 "processed_pseudogene" = "#FBB04E",
                 "novel" = "#B09C85")) + 
...
b2 =ggpie(transl_liversp_genetype_plot, x="Freq", fill = "Var1", palette=c("protein_coding"="#849DB1",
                 "lncRNA" = "#B66353",
                 "processed_pseudogene" = "#FBB04E",
                 "novel" = "#B09C85")) + 
...
c2 = ggpie(transl_testissp_genetype_plot, x="Freq", fill = "Var1", palette=c("protein_coding"="#849DB1",
                 "lncRNA" = "#B66353",
                 "processed_pseudogene" = "#FBB04E",
                 "novel" = "#B09C85")) + 
...
a3 = ggpie(transl_brainspgtex_genetype_plot, x="Freq", fill = "Var1", palette=c("protein_coding"="#849DB1",
                 "lncRNA" = "#B66353",
                 "processed_pseudogene" = "#FBB04E",
                 "novel" = "#B09C85")) + 
...
b3 = ggpie(transl_liverspgtex_genetype_plot, x="Freq", fill = "Var1", palette=c("protein_coding"="#849DB1",
                 "lncRNA" = "#B66353",
                 "processed_pseudogene" = "#FBB04E",
                 "novel" = "#B09C85")) + 
...
c3 = ggpie(transl_testisspgtex_genetype_plot, x="Freq", fill = "Var1", palette=c("protein_coding"="#849DB1",
                 "lncRNA" = "#B66353",
                 "processed_pseudogene" = "#FBB04E",
                 "novel" = "#B09C85")) + 
