...
translated_only_testis = read.csv(file.path(Q2_wd,"testisRestricted_GTEx_translatedONLYtestis.noProteome.csv"))
...
TAA_long = read.csv(file.path(pre_save_wd,"TAAdata_long.csv"))

temporary = TAA_long %>% select(gene_name, gene_type, ctype) %>% unique()
