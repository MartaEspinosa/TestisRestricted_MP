...
<!-- ```{r TestisOv2x_TumorSpecific, echo=F} -->
<!-- TOv2x_testis = TOv2x_GTEX_all %>% mutate(testisRestricted_GTEx = case_when(gene_id %in% testisRestricted_GTEx$gene_id ~ "testisRestricted_GTEx", -->
<!--                                                                        TRUE ~ "no")) -->

<!-- # TOv2x_testis_proportions = TOv2x_testis %>% -->
