...
ggsave("/users/genomics/marta/TestisProject_SaraRazquin/with_TranscriptomeReconstruction/macaca/plots/PNG/TPM_density.png", width=6.64, height=8.78)
ggsave("/users/genomics/marta/TestisProject_SaraRazquin/with_TranscriptomeReconstruction/macaca/plots/PDF/TPM_density.pdf", width=6.64, height=8.78)
...
ggplot(TPMs_complete %>% subset(gene_type == "lncRNA" | gene_type == "processed_pseudogene" | gene_type == "novel" | gene_type == "protein_coding"), aes(x=gene_type, y=logTPM, fill=gene_type)) +
  ...
  facet_wrap(~ sample, ncol=3)
ggsave("/users/genomics/marta/TestisProject_SaraRazquin/with_TranscriptomeReconstruction/macaca/plots/PNG/TPM_boxplot.png", width=6.64, height=8.78)
ggsave("/users/genomics/marta/TestisProject_SaraRazquin/with_TranscriptomeReconstruction/macaca/plots/PDF/TPM_boxplot.pdf", width=6.64, height=8.78)
...
ggplot(TPMs_length_300 %>% subset(gene_type == "lncRNA" | gene_type == "processed_pseudogene" | gene_type == "novel" | gene_type == "protein_coding"), aes(x=Length, fill=gene_type)) +
  ...
  theme(legend.position = "top") +
  facet_wrap(~ sample, ncol=3)
ggsave("/users/genomics/marta/TestisProject_SaraRazquin/with_TranscriptomeReconstruction/macaca/plots/PNG/length_tableofcounts_density.300.png", height=6.64, width=8.78)
ggsave("/users/genomics/marta/TestisProject_SaraRazquin/with_TranscriptomeReconstruction/macaca/plots/PDF/length_tableofcounts_density.300.pdf", height=6.64, width=8.78)
...
ggplot(TPMs_length_300 %>% subset(gene_type == "lncRNA" | gene_type == "processed_pseudogene" | gene_type == "novel" | gene_type == "protein_coding"), aes(x=logTPM, fill=gene_type)) +
  ...
  theme(legend.position = "top") +
  facet_wrap(~ sample, ncol=3)
ggsave("/users/genomics/marta/TestisProject_SaraRazquin/with_TranscriptomeReconstruction/macaca/plots/PNG/TPM_density.300.png", width=6.64, height=8.78)
ggsave("/users/genomics/marta/TestisProject_SaraRazquin/with_TranscriptomeReconstruction/macaca/plots/PDF/TPM_density.300.pdf", width=6.64, height=8.78)
...
ggplot(TPMs_length_300 %>% subset(gene_type == "lncRNA" | gene_type == "processed_pseudogene" | gene_type == "novel" | gene_type == "protein_coding"), aes(x=gene_type, y=logTPM, fill=gene_type)) +
  ...
  theme(legend.position = "top",
        axis.text.x = element_text(angle=45, vjust=.75)) +
  facet_wrap(~ sample, ncol=3)
ggsave("/users/genomics/marta/TestisProject_SaraRazquin/with_TranscriptomeReconstruction/macaca/plots/PNG/TPM_boxplot.300.png", width=6.64, height=8.78)
ggsave("/users/genomics/marta/TestisProject_SaraRazquin/with_TranscriptomeReconstruction/macaca/plots/PDF/TPM_boxplot.300.pdf", width=6.64, height=8.78)
