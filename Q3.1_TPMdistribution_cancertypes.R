...
for (ctype in cancers) {
  ...
  ggsave(paste0("/projects_eg/projects/marta/TestisRestricted_Microproteins_TSA/with_TranscriptomeReconstruction/plots/PNG/TPMdistribution_ctype,".png"), width=5.41, height=4.66)
  ggsave(paste0("/projects_eg/projects/marta/TestisRestricted_Microproteins_TSA/with_TranscriptomeReconstruction/plots/PDF/TPMdistribution_ctype,".pdf"), width=5.41, height=4.66)
  ...
  #   facet_wrap(~ sample)
  #   ggsave(paste0("/projects_eg/projects/marta/TestisRestricted_Microproteins_TSA/with_TranscriptomeReconstruction/plots/PNG/TPMdistribution_other_projects_per_sample,"_persample.png"), width=5.41, height=4.66)
