...
ggplot(CDI_dataframe_ctype, aes(x=ctype, y=CDI, color=type, group=type)) +
  # geom_line() +
  geom_point(size=3) +
...
# names(tables_of_counts)[1] = "transcript_id"
# tables_of_counts = merge(tables_of_counts, annot, by="transcript_id")
# TPMs_CTDB = merge(tables_of_counts, CTDB, by="transcript_id")
